class MovieListView {
    constructor(controller){
        ...
        this.back.addEventListener('click',(event)=>this.listViewBtnListener(event));
    }
    ...
    listViewBtnListener(event){
        ...
        const targetEle = event.target;        
             console.log(targetEle.parentNode.classList);
        if(targetEle.classList.contains('list-view-button') || targetEle.parentNode.classList.contains('list-view-button')){              
